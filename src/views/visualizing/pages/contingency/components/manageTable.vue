      ...
      <el-row>
        ...
        <el-col :span="8"
          ...
          <el-form-item label="毁伤类型"
                        prop="damageType">
            <el-select v-model="tableData.param.damageType"
                       placeholder="请选择毁伤类型">
        ...
        <el-col :span="8"
          ...
          <el-form-item>
            <el-button type="primary"
                       ...
                       @click="PlanMgrList">查询</el-button>
            <el-button type="primary"
                       class="search-form-btn"
        ...
        <el-col :span="8"
          ...
          <el-form-item label="攻击手段"
                        prop="attackMethod">
            <el-select v-model="tableData.param.attackMethod"
                       placeholder="请选择攻击手段"
                       clearable>
        ...
        <el-col :span="8"
                :class="showAll ? 'colBlock' : 'colNone'">
          <el-form-item label="武器型号"
                        prop="weaponModel">
            <el-input v-model="tableData.param.weaponModel"
                      placeholder="请输入武器型号"
                      clearable
                      @keyup.enter.native="PlanMgrList" />
          </el-form-item>
        ...
        <el-col :span="8"
          ...
          <el-form-item label="数量"
                        prop="weaponNum">
            <el-input v-model="tableData.param.weaponNum"
                      placeholder="请输入数量"
                      clearable
                      @keyup.enter.native="PlanMgrList" />
          </el-form-item>
        ...
        <el-col :span="8"
                :class="showAll ? 'colBlock' : 'colNone'">
          <el-form-item label="是否有防御模型"
                        prop="defenseFlag">
            <el-select v-model="tableData.param.defenseFlag"
                       placeholder="请选择是否有防御模型"
                       clearable>
              <el-option label="请选择字典生成"
                         value="" />
            </el-select>
        ...
        <el-col :span="8"
                :class="showAll ? 'colBlock' : 'colNone'">
          <el-form-item label="防御武器"
                        prop="defensiveWeapon">
            <el-select v-model="tableData.param.defensiveWeapon"
                       placeholder="请选择防御武器"
                       clearable>
              <el-option label="请选择字典生成"
                         value="" />
        ...
        <el-col :span="8"
                :class="showAll ? 'colBlock' : 'colNone'">
          <el-form-item label="风幕类型"
                        prop="windType">
            <el-input v-model="tableData.param.windType"
                      placeholder="请输入风幕类型"
                      clearable
                      @keyup.enter.native="PlanMgrList" />
          </el-form-item>
        ...
        <el-col :span="8"
                :class="showAll ? 'colBlock' : 'colNone'">
          <el-form-item label="风幕数量"
                        prop="windNum">
            <el-input v-model="tableData.param.windNum"
                      placeholder="请输入风幕数量"
                      clearable
                      @keyup.enter.native="PlanMgrList" />
          </el-form-item>
        ...
        <el-col :span="8"
                :class="showAll ? 'colBlock' : 'colNone'">
          <el-form-item label="风幕高度"
                        prop="windH">
            <el-input v-model="tableData.param.windH"
                      placeholder="请输入风幕高度"
                      clearable
                      @keyup.enter.native="PlanMgrList" />
          </el-form-item>
        ...
        <el-col :span="8"
          ...
          <el-form-item label="操作员"
                        prop="operator">
            <el-input v-model="tableData.param.operator"
                      placeholder="请输入操作员"
                      clearable
                      @keyup.enter.native="PlanMgrList" />
          </el-form-item>
        ...
        <el-col :span="8"
          ...
          <el-form-item>
            <el-button type="primary"
                       @click="PlanMgrList"><el-icon><ele-Search /></el-icon>搜索</el-button>
      ...
      <el-table-column label="操作"
        ...
        <template #default="scope">
          <el-button type="primary"
                     ...
                     v-auth="'api/v1/sim/planMgr/get'"><el-icon><ele-View /></el-icon>查看</el-button>
          <el-button v-if="scope.row.status !== 1"
                     type="primary"
                     link
                     @click="handleUpdate(scope.row)"
                     v-auth="'api/v1/sim/planMgr/edit'"><el-icon><ele-EditPen /></el-icon>编辑</el-button>
          <el-button v-if="scope.row.status !== 1"
                     type="primary"
                     link
                     @click="handleDelete(scope.row)"
                     v-auth="'api/v1/sim/planMgr/delete'"><el-icon><ele-DeleteFilled /></el-icon>删除</el-button>
        </template>
      </el-table-column>
    </el-table>
