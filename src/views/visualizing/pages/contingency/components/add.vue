 ...
 * @LastEditors: 王翔
 * @LastEditTime: 2024-12-16 14:46:50
...
<template>
  <div class="contingency-add">
    <div class="bg-container" :class="{'bg-container-show-table':!showFrom}">
      <div class="map-container">
        <mainScreen></mainScreen>
      </div>
    </div>
      <manageTable ref="tableRef" v-show="!showFrom" @handleAdd="handleAdd"/>
    <div class="bg-container" v-show="showFrom">
      <addForm ref="addFormRef" @operateDone="operateDone" @cancel="showFrom=false"></addForm>
    </div>
  </div>
</template>
<script setup>
